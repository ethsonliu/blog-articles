...
![](https://resource.ethsonliu.com/image/20190920_01.png)

根据单词 {"china", "hit", "use"} 建立字典树。

（2）

![](https://resource.ethsonliu.com/image/20190920_02.png)

根据所给文本 "chitchat" 依次匹配，图中所示 "chi" 为匹配成功的字符串。

（3）

![](https://resource.ethsonliu.com/image/20190920_03.png)

当匹配到第四个字符时，"t" 和 "n" 匹配失败。

（4）

![](https://resource.ethsonliu.com/image/20190920_04.png)
...
![](https://resource.ethsonliu.com/image/20190920_05.png)
...
![](https://resource.ethsonliu.com/image/20190920_06.png)
